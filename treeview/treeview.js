	...
	$.extend($.fn, {
		...
		applyClasses: function(settings, toggler) {
			...
			if (!settings.prerendered) {
				...
				this.filter(":has(>ul:hidden)").addClass(CLASSES.expandable)
						
				// handle open ones
				this.not(":has(>ul:hidden)").addClass(CLASSES.collapsable)
